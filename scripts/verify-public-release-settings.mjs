...
const canonicalRepository = 'craveup/cravejs-expo-template';
...
function readRepositorySetting(endpoint) {
  return JSON.parse(
    execFileSync('gh', ['api', '-H', `X-GitHub-Api-Version: ${apiVersion}`, endpoint], {
      encoding: 'utf8',
...
if (isDirectExecution()) {
  try {
    ...
    const code =
      error instanceof PublicReleaseSettingsError ? error.code : 'PUBLIC_RELEASE_SETTINGS';
